...
class Load_Fixed_Width:
    def __init__(self, section, log):
        """
        Constructor to accept the name of the section and logger object
        :param section:
        """
    ...
    def read_fixed_width(self):
        ...
        spec_details = read_col_specs(self.section, self.log)

        # read the fixed width file by providing the arguments in the widths as list of position
        filename = read_table_details(self.log, self.section)['file_name']
        print(filename)
    ...
    def create_db_connection(self):
        ...
        :return: Connection
        """
        config = read_config(self.section, self.log)
    ...
    def load_into_table(self, data, connection):
        ...
        :return:
        """
        tbl_details = read_table_details(self.log, self.section)
...
if __name__ == '__main__':
    ...
    section = 'departments'
    fwf = Load_Fixed_Width(section, log)
    print(fwf.main())
    # import logging
